...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-198043475-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-198043475-1');
    </script>
    ...
    })(window,document,'script','dataLayer','GTM-TRQLZB9');</script>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TRQLZB9"
